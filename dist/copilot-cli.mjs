...
// cli/node_modules/webidl-conversions/lib/index.js
var require_lib = __commonJS({
  "cli/node_modules/webidl-conversions/lib/index.js"(exports, module) {
    "use strict";
    var conversions = {};
...
// cli/node_modules/whatwg-url/lib/utils.js
var require_utils = __commonJS({
  "cli/node_modules/whatwg-url/lib/utils.js"(exports, module) {
    "use strict";
...
// cli/node_modules/tr46/lib/mappingTable.json
var require_mappingTable = __commonJS({
  "cli/node_modules/tr46/lib/mappingTable.json"(exports, module) {
...
// cli/node_modules/tr46/index.js
var require_tr46 = __commonJS({
  "cli/node_modules/tr46/index.js"(exports, module) {
    "use strict";
...
// cli/node_modules/whatwg-url/lib/url-state-machine.js
var require_url_state_machine = __commonJS({
  "cli/node_modules/whatwg-url/lib/url-state-machine.js"(exports, module) {
    "use strict";
    var punycode = __require("punycode");
...
// cli/node_modules/whatwg-url/lib/URL-impl.js
var require_URL_impl = __commonJS({
  "cli/node_modules/whatwg-url/lib/URL-impl.js"(exports) {
    "use strict";
...
// cli/node_modules/whatwg-url/lib/URL.js
var require_URL = __commonJS({
  "cli/node_modules/whatwg-url/lib/URL.js"(exports, module) {
    "use strict";
...
// cli/node_modules/whatwg-url/lib/public-api.js
var require_public_api = __commonJS({
  "cli/node_modules/whatwg-url/lib/public-api.js"(exports) {
    "use strict";
...
// cli/node_modules/node-fetch/lib/index.js
var require_lib2 = __commonJS({
  "cli/node_modules/node-fetch/lib/index.js"(exports, module) {
    "use strict";
...
var PAT_FILE = path.join(homedir, ".copilot-pat");
...
async function savePAT(pat) {
  try {
    fs.writeFileSync(PAT_FILE, pat, { mode: 384 });
  ...
  try {
    ...
    if (cmd === "write") {
      ...
      try {
        ...
        let oldText = "";
        try {
          oldText = fs.existsSync(absTarget) ? fs.readFileSync(absTarget, "utf8") : "";
        } catch (e) {
          oldText = "";
        }
...
Output nothing else.`;
      ...
      if (flags.interactive) {
        ...
        const rl = readline.createInterface({ input: process.stdin, output: process.stdout, historySize: 1e3 });
        let lastSearch = [];
              ...
              case "write": {
                ...
                try {
                  ...
                  if (wsFlagsAgent.workspace)
                    ...
                    fs.writeFileSync(absTarget, text, "utf8");
                  ...
                  if (isGitRepo(wsFlagsAgent.workspace || process.cwd())) {
                    ...
                    try {
                      ...
                      if (m) {
                        ...
                        if (wsFlagsAgent.workspace && !isPathInside(path.resolve(wsFlagsAgent.workspace), abs))
...
async function ensureFetchAvailable() {
  if (typeof fetch !== "undefined")
    return;
  try {
    const nodeFetch = await Promise.resolve().then(() => __toESM(require_lib2(), 1));
